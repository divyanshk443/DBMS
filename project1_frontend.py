...
class Student:
    ...
    def __init__(self,root):
       ...
       pb.studentData()
       def iExit():
              iExit=tkinter.messagebox.askyesno("Divyansh's student dbms","confirm if you want to exit")
              if iExit>0:
                     root.destroy()
                     return
       def clearData():
       ...
       MainFrame.pack()  #THIS IS MAIN FRAME OUR WINDOW
       TitFrame=Frame(MainFrame,bg="red")
       ...
       self.lblTit=Label(TitFrame,font=('arial',25,'bold'),text="IIT BHILAI",bg="red",fg="black")
       self.lblTit.grid()

       self.lblTit=Label(TitFrame,font=('arial',18),text="(created by Divyansh Khandelwal)",bg="red",fg="black")
       self.lblTit.grid()

       ButtonFrame=Frame(MainFrame,bd=1,width=1350,height=70,padx=18,pady=10,bg="red",relief=RIDGE)
       ButtonFrame.pack(side=BOTTOM)#

       DataFrame=Frame(MainFrame,bd=9,width=1300,height=400,padx=20,pady=20,bg="light pink")
       DataFrame.pack(side=BOTTOM)#THIS IS STI
         
       DataFrameLeft=LabelFrame(DataFrame,font=('arial',12,'bold'),bd=7,width=450,height=300,bg="ghost white",text="STUDENT INFO\n",relief=RIDGE)
       DataFrameLeft.pack(side=LEFT)

       DataFrameRight=LabelFrame(DataFrame,font=('arial',12,'bold'),bd=7,width=450,height=300,bg="ghost white",relief=RIDGE,text="STUDENT DETAILS\n")
...
#########################################################Lables and entry widget #######################################################################
       ...
       self.txtStdId=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=stdId,width=39)
       ...
       self.txtFirstname=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Firstname,width=39)
       ...
       self.txtSurname=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Surname,width=39)
       ...
       self.txtDob=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=DoB,width=39)
       self.txtDob.grid(row=3,column=1)#dateof birth

       self.lblAge=Label(DataFrameLeft,font=('arial',12,'bold'),padx=2,pady=3,text="Age:")
       self.lblAge.grid(row=4,column=0,sticky=W)
       
       self.txtAge=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Age,width=39)
       ...
       self.txtGender=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Gender,width=39)
       ...
       self.txtAdress=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Adress,width=39)
       ...
       self.txtMobile=Entry(DataFrameLeft,font=('arial',12,'bold'),textvariable=Mobile,width=39)
